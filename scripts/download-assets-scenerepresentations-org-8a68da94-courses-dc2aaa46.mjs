...
const pageRoot = join(projectRoot, "public/sites/scenerepresentations-org-8a68da94/courses-dc2aaa46");
const sharedRoot = join(projectRoot, "public/sites/scenerepresentations-org-8a68da94/shared");
const sharedUrls = new Set([]);
const urls = [
  "https://scenerepresentations.org/_astro/thumbnail.a6OMR3S7_13MB44.avif",
  "https://scenerepresentations.org/_astro/thumbnail.a6OMR3S7_Z1RFIhi.avif",
  "https://scenerepresentations.org/_astro/thumbnail.D4pik0aJ_cdxQK.avif",
  "https://scenerepresentations.org/_astro/thumbnail.D_8Fk3v4_2akwuw.avif",
  "https://scenerepresentations.org/_astro/thumbnail.D4pik0aJ_vSNJo.avif",
  "https://scenerepresentations.org/_astro/thumbnail.D_8Fk3v4_ZL8MPP.avif"
];
